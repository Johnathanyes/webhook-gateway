...
-- Single-user auth, OIDC-ready: password_hash and
...
-- API keys are how the CLI and any external caller authenticate.
...
-- tenant-scoped: telemetry instance id encryption key version in
